...
from qiskit.transpiler.passes import Unroller, CheckGateDirection
...
from optimizers.rpo.purestate.pure_state_on_U import PureStateOnU


def custom_pass_manager(pass_manager_config: PassManagerConfig, opt_code: str) -> PassManager:
    """
    Args:
